...
public class person_detection_display extends PApplet {
...
public void draw()
{
  ...
  String text = String.format("Person: %.2f%%", ((score[0] + 128)/256.0f * 100));
  text(text, 0, 25);
}
int state = 0;
int read = 0;
...
public void serialEvent(Serial myPort) {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "person_detection_display" };
    if (passedArgs != null) {
